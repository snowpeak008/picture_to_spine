...
| 11-M10-Windows打包入口更新.md | `5da1335275702ff079517d5977777f2e0f4e9f0b443754aa72453f2472c15d04` |
...
| F2S-DEV-M10-001 | 2 | apps/desktop/src-tauri/tauri.conf.json、installer/nsis/core.nsi。<br>installer/nsis/worker-pack.nsi、installer/nsis/model-pack.nsi、tests/packaging/package-layout.spec.ts。 | 锁 repo:apps/desktop/src-tauri/tauri.conf.json、repo:installer/nsis/core.nsi、repo:dist/windows/core。<br>锁 repo:installer/nsis/worker-pack.nsi、repo:installer/nsis/model-pack.nsi、repo:tests/packaging/package-layout.spec.ts。 |
