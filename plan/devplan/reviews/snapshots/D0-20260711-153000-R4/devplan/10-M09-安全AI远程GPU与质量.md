...
##### F2S-WU-M09-005-01 — 核心性能预算
   ...
   - reads：Desktop instrumentation、标准 fixture、NFR thresholds、F2S-DEV-M07-003 performance-fixture-contract、F2S-EVD-M07-003 raw/profile/hash。
   ...
   - evidence：evidence/M09/F2S-DEV-M09-005/F2S-WU-M09-005-01/performance-summary.json、raw-traces/**。
...
##### F2S-WU-M09-005-02 — B08渲染与8GB矩阵
   ...
   - reads：renderer、WebView2 exact version、DPI 100/125/150/200%、F2S-DEV-M09-001 Worker probe、8GB GPU、F2S-DEV-M07-003 performance-fixture-contract、F2S-EVD-M07-003 raw/profile/hash。
   ...
   - evidence：evidence/M09/F2S-DEV-M09-005/F2S-WU-M09-005-02/evidence.json、b08-renderer-matrix.json、gpu8gb-preflight.json；缺 GPU/pack 格为 NOT_RUN/EXTERNAL。
