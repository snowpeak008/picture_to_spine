...
##### F2S-WU-M10-001-01 — Core安装布局
   ...
   - parallelSafety：锁 repo:installer/tauri/tauri.release.overlay.json、repo:installer/nsis/core.nsi、repo:dist/windows/core；apps/desktop/src-tauri/tauri.conf.json 只读。
...
##### F2S-WU-M10-004-01 — 键盘焦点与简中
   ...
   - parallelSafety：锁 repo:apps/desktop-ui/src/platform/windows-a11y.ts、repo:apps/desktop-ui/src/features/release/i18n/zh-CN.json、repo:tests/ui/windows-accessibility.spec.ts；全局 zh-CN catalog 只读。
