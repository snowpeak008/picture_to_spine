---
schemaVersion: 1
evidenceId: F2S-REV-R3A-PREFLIGHT-001
phase: R3A_PREFLIGHT_REJECTED
snapshotId: R3A-20260711-051944
createdAt: 2026-07-11T05:19:44+08:00
timezone: Asia/Shanghai
fileCount: 25
archivePath: plan/reviews/snapshots/R3A-20260711-051944.zip
archiveSha256: a11efb8f4a78e6efc58e9c6a5d7e0764b12361b75d7ed6e5ee84f2baa42e329c
verdict: REJECTED_BEFORE_SCORING
---

# R3a preflight-rejected snapshot manifest

This archive preserves the actual candidate bytes but is not scoring or gate evidence. Independent preflight found `F2S-R3A-PRE-UI-STATE-001` (05 treated `needs_review` as Lifecycle) and `F2S-R3A-PRE-GATE-HASH-001` (GateReport hash/request contract incomplete). The live documents were remediated after this immutable snapshot; a later snapshot must be used for R3a scoring.

Snapshot command used Windows PowerShell 5.1.22621.4391 with `Copy-Item` and `Compress-Archive -CompressionLevel Optimal`. It copied only the 25 direct `plan/*.md` files into `plan/reviews/snapshots/R3A-20260711-051944/plan`, verified live/copy SHA-256 equality, marked copied files and archive read-only, then hashed the archive. No review consumed live files as substitutes for this snapshot.
...
| 05-UI设计系统与页面规格.md | F2S-DOC-UI-001 | 1.4 | 30572 | e24cfe5e5c9adefbe865781bb6ffc0add8d202645b8a33cebd7ec24f00ace3f0 |
...
| 09-领域逻辑与工作流编排.md | F2S-DOC-DOMAIN-001 | 1.7 | 28554 | 166cee17b7033300f9ac8e3ab429cfd464a415964d720b53398f71e4d6c415c5 |
